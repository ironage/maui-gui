function range = getBestSearchRange( refVert, currVert, upORdown)
...
meanDist = round(mean(distance));
if meanDist > maxSearchRane
%     distance = 10;
    range = -maxSearchRane:maxSearchRane;
elseif upORdown==1
    range = -maxSearchRane : meanDist;
else
    range = -meanDist : maxSearchRane;
end
